...
: ${AMENT_CURRENT_PREFIX:="/home/student/CourierBot/install/audio_common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/audio_common/environment/library_path.sh"
